...
const OPENAI_BASE_URL = import.meta.env.VITE_DEFAULT_OPENAI_BASE_URL || "";
...
export function createModelChannel(channel?: Partial<Omit<ModelChannel, "models">> & { models?: Array<string | ChannelModel> }): ModelChannel {
